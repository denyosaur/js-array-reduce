...
function vowelCount(str) {
    ...
    let vowels = "aeiou";
    return strArr.reduce(function (vowelsCount, char) {
...
function addKeyAndValue(arr, key, value) {
    return arr.reduce(function (updatedArr, obj, idx) {
        updatedArr[idx][key] = value;
        return updatedArr;
    }, arr);
};
...
function partition(arr, callback) {
    return arr.reduce(function (newArr, ele) {
        if (callback(ele)) {
            newArr[0].push(ele);
        } else {
            newArr[1].push(ele);
